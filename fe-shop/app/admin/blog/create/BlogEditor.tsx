...
export default function BlogEditor() {
    ...
    useEffect(() => {
        ...
        async function fetchData() {
            ...
            // Nếu có category_id từ URL và category tồn tại, tự động chọn category đó
            if (categoryIdFromUrl) {
                const categoryExists = data.data.some((cat: BlogCategory) => cat.id.toString() === categoryIdFromUrl)
                if (categoryExists) {
