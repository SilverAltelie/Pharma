    ...
    <h2 className="font-semibold text-gray-900">Cập nhật người dùng</h2>
      ...
      <div className="space-y-12 px-5 mb-8 border-2 rounded-md">
        ...
        <div className="border-b border-gray-900/10 pb-12">
          ...
          <div className="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
            ...
            <div className="sm:col-span-3">
              ...
              <div className="mt-2">
                <input
                defaultValue={user?.address.last_name}
                  id="last-name"
                  name="last-name"
                  type="text"
        ...
        <div className="my-4 flex justify-end gap-4">
            <button type="button" className="bg-red-600 text-white px-4 py-2 rounded-md hover:bg-green-700 transition">Hủy</button>
            <button type="submit" className="bg-green-600 text-white px-4 py-2 rounded-md hover:bg-green-700 transition">Lưu</button>
            </div>
